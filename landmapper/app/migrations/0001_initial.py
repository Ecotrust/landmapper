...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('odf_fpd', models.CharField(blank=True, default=None, max_length=25, null=True)),
                ('agency', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('orzdesc', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('huc12', models.CharField(blank=True, default=None, max_length=12, null=True)),
                ('name', models.CharField(blank=True, default=None, max_length=120, null=True)),
                ('min_elevation', models.FloatField(blank=True, default=None, null=True)),
                ('max_elevation', models.FloatField(blank=True, default=None, null=True)),
                ('legal_label', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ...
                ('map_id', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('map_taxlot', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('geometry', django.contrib.gis.db.models.fields.MultiPolygonField(blank=True, null=True, srid=3857, verbose_name='Grid Cell Geometry')),
            ],
            options={
                'verbose_name': 'Taxlot',
