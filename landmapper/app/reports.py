...
def create_property_pdf(property, property_id):
    ...
    template_input_dict = {
        ...
        'scale_forestsize': scalebar_names[settings.FOREST_SIZE_SCALE],
        'scale_forestcanopy': scalebar_names[settings.FOREST_CANOPY_SCALE],
        'scale_forestdensity': scalebar_names[settings.FOREST_DENSITY_SCALE],
