...
def create_property_pdf(property, property_id):
    ...
    template_input_dict = {
        ...
        'foresttypesscale': scalebar_names[settings.FOREST_TYPES_SCALE],
        'forestsizescale': scalebar_names[settings.FOREST_SIZE_SCALE],
        'forestcanopyscale': scalebar_names[settings.FOREST_CANOPY_SCALE],
        'forestdensityscale': scalebar_names[settings.FOREST_DENSITY_SCALE],
