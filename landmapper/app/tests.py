...
class ModelTests(TestCase):
    ...
    def test_forest_type(self):
        from app.models import ForestType
...
class ViewTests(TestCase):
    ...
    def test_soils_api(self):
        ...
        from app.views import get_soil_data_gml, get_soil_overlay_tile_data, get_soils_list, unstable_request_wrapper
    ...
    def test_bbox_to_string(self):
        from app.map_layers.utilities import get_bbox_as_string
        from app.models import Taxlot
    ...
    def test_tiles(self):
        ...
        # from app.views import get_aerial_image, image_result_to_PIL, get_soil_overlay_tile_data, merge_images, get_property_from_taxlot_selection, get_bbox_as_string, get_bbox_from_property
        from app.views import get_property_from_taxlot_selection, get_soil_report_image, get_streams_report_image
        # from django.contrib.gis.geos import GEOSGeometry
        from app.models import Taxlot
    ...
    def test_identify_gather(self):
        ...
        IN:
            ...
            (opt) property name
        """
        from app.views import identify
    ...
    def test_create_property(self):
        ...
        NOTES:
            should be cached
        """
        # from app.views import create_property
    ...
    def test_get_taxlot_json(self):
        ...
        from app.views import get_taxlot_json
        from app.models import Taxlot
        print('Finish test')
    ...
    #     from app.models import MenuPage
    #     from app.views import get_menu_page
